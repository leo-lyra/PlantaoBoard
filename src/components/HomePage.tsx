...
import { 
  Plus, BarChart3, Calendar, MapPin, Stethoscope, ArrowRight,
...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const features = [
    { icon: Target, title: 'Controle Preciso', description: 'Acompanhe cada plantão com detalhes completos e métricas precisas' },
    { icon: BarChart3, title: 'Analytics Avançado', description: 'Dashboards interativos com insights profundos sobre seus ganhos' },
    { icon: Shield, title: 'Dados Seguros', description: 'Seus dados ficam salvos localmente com total segurança e privacidade' },
    { icon: Zap, title: 'Interface Rápida', description: 'Design moderno e responsivo para máxima produtividade' }
  ];
  ...
  return (
    <MobileShell>
      {/* container centralizado com respiro lateral em telas pequenas */}
      <div className="space-y-8 mx-auto max-w-[420px] sm:max-w-[540px] md:max-w-3xl px-4 sm:px-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800 rounded-3xl p-8 md:p-12 text-white">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight leading-snug">PlantãoBoard</h1>
