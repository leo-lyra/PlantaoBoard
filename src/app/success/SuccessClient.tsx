    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">🎉 <span className="text-emerald-600">Parabéns!</span></h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-6">Sua assinatura foi ativada com sucesso!</p>
        ...
        <Card className="border-0 shadow-xl bg-gradient-to-r from-emerald-50 to-blue-50 mb-8">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Agora você tem acesso completo!</h2>
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              {['Dashboard Completo','Relatórios Avançados','Suporte Premium','Backup Automático'].map((t)=>(
        ...
        <Card className="mt-8 bg-gray-50">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-600 mb-4">Nossa equipe está pronta para te ajudar a aproveitar ao máximo o PlantãoMed</p>
